      ...
      <header className="flex items-center gap-6">
        ...
        <div className="space-y-2">
          ...
          <ul className="flex gap-6 text-sm">
            ...
            <li>
              <span className="font-semibold">1,248</span> followers
            </li>
            <li>
              <span className="font-semibold">506</span> following
            </li>
          </ul>
            ...
            <div className="space-y-3">
              ...
              <div>
                ...
                <textarea
                  ...
                  className="mt-1 h-24 w-full rounded-md border bg-background p-3 text-sm outline-none"
                  maxLength={160}
                />
