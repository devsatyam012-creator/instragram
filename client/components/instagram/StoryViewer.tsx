  ...
  return (
    <div className="fixed inset-0 z-[60] bg-black/90">
      ...
      <div className="absolute left-1/2 top-6 w-[92%] max-w-md -translate-x-1/2">
        ...
        <div className="flex items-center gap-3 text-white">
          ...
          <button
            ...
            className="ml-auto inline-flex items-center gap-1 rounded-full bg-white/10 px-3 py-1 text-xs font-semibold"
          >
      ...
      <div className="absolute left-1/2 top-1/2 w-[92%] max-w-md -translate-x-1/2 -translate-y-1/2">
        ...
        <button
          onClick={prev}
          className="absolute left-1 -translate-x-full top-1/2 -translate-y-1/2 rounded-full bg-white/10 p-2 text-white hover:bg-white/20"
        >
          <ChevronLeft />
        </button>
        <button
          onClick={next}
          className="absolute right-1 translate-x-full top-1/2 -translate-y-1/2 rounded-full bg-white/10 p-2 text-white hover:bg-white/20"
        >
          <ChevronRight />
        </button>
      </div>
