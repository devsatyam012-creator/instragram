    ...
    >
      <div className="mx-auto flex h-14 max-w-6xl items-center justify-between px-4 sm:h-16">
        <div className="flex items-center gap-3">
          ...
          <a
            href="/"
            className="font-extrabold text-xl tracking-tight bg-gradient-to-r from-fuchsia-500 via-pink-500 to-amber-400 bg-clip-text text-transparent"
          >
            Gram
          </a>
        </div>
        ...
        <nav className="flex items-center gap-4">
          ...
          <a
            href="/messages"
            aria-label="Messages"
            className="p-2 hover:text-primary hidden sm:inline-flex"
          >
          ...
          <a
            href="/profile"
            aria-label="Profile"
            className="inline-flex h-8 w-8 items-center justify-center overflow-hidden rounded-full ring-1 ring-border"
          >
            <img
              src={(() => {
                try {
                  const p = JSON.parse(
                    localStorage.getItem("gram.profile") || "{}",
                  );
                  return p.avatar || "https://i.pravatar.cc/64?img=15";
                } catch {
                  return "https://i.pravatar.cc/64?img=15";
                }
              })()}
              alt="Me"
